  ...
  return (
    <main className="bg-[url('../public/hero_img.jpg')] bg-contain bg-[#040711] bg-no-repeat w-[100%] h-screen flex flex-col items-center">
      ...
      <div className="flex flex-col items-center xl:grid xl:grid-cols-2">
        <div className="mt-[60px] bg-[#212936cc] rounded-3xl border border-[#4D5562] w-[590px] h-[340px] md:w-[880px] md:mr-[70px] md:ml-[70px] mr-[60px] ml-[60px] md:text-[20px] xl:w-[560px] xl:ml-[70px] xl:mr-[156px]">
          ...
          <div>
            ...
            <textarea 
              className="bg-transparent w-full h-[160px] pt-6 pl-6 pr-6" 
              type="input" 
        ...
        <div className="mt-5 bg-[#212936cc] rounded-3xl border border-[#4D5562] w-[590px] h-[340px] md:w-[880px] md:mr-[70px] md:ml-[70px] mr-[60px] ml-[60px] md:text-[20px] xl:w-[560px] xl:mr-[70px] xl:ml-[0px] xl:mt-[60px] xl:text-[16px]">
